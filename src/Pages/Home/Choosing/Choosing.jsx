        ...
        <div className='relative'>
            <Container>
                ...
                <section className='flex flex-wrap justify-between items-center mb-44 '>
                    {/* images */}
                    <div className='relative mx-auto lg:mx-0 w-[200px] lg:w-auto mb-34 lg:mb-0'>
                ...
                <section className='flex flex-wrap  flex-row-reverse justify-between items-center mb-64 '>
                    {/* images */}
                    <div className='relative mx-auto lg:mx-0  w-[200px] lg:w-auto mb-52 lg:mb-0'>
                ...
                <section className='flex flex-wrap flex-row-reverse  justify-between items-center mb-44 '>
                    {/* images */}
                    <div className='relative lg:mx-0 mx-auto  w-[200px] lg:w-auto mb-34 lg:mb-0'>
